...
{
    public class ProdutosRepository : BaseRepository, IProdutosRepository, IDisposable
    {
        public ProdutosRepository(IDatabaseFactory databaseFactory) : base(databaseFactory)
        {
